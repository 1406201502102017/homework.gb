...
// 3. Внутри класса «Сотрудник» написать метод, который выводит информацию об объекте в консоль.
    public static void infoEmployee (String name, String position, String email, String numberPhone, int salary, int age) {
...
// 5. С помощью цикла вывести информацию только о сотрудниках старше 40 лет.
    ...
    public static void main(String[] args) {
        infoEmployee("Вася", "механик", "vasya@mail.ru", "+79065625147", 50000, 42);
        System.out.println();
        staffArr();
    }
}
